...
let divisonResult = double10 / double3
print(divisonResult)

// Using double allows the program to display the whole number and decimal parts of the divison while Int only displays the whole number part.
/*:
